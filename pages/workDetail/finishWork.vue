<template>
	<view class="content">
		...
		<view class="messageBox">
			...
			<view class="message">
				<ul :style="{ left: -tabIndex * 100 + '%' }" v-if="dataMessage">
					<li>
						<view class="qiun-charts chart"><canvas canvas-id="canvasRing" id="canvasRing" class="charts" @touchstart="touchRing" /></view>
		...
		<view class="tableTitleWrap">
			<view class="tableTitle" v-text="'订单生产记录'" />
		</view>
...
.content {
	...
	.main {
		...
		ul {
			...
			li {
				list-style: none;
				border-bottom: 0.5upx solid #e3e3e3;
				padding: 1upx 0;
				height: 50upx;
				text {
					color: #828282;
